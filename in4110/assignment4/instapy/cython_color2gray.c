...
static PyArrayObject *__pyx_f_7instapy_17cython_color2gray_cython_color2gray(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_7instapy_17cython_color2gray_cython_color2gray(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img); /* proto */
...
/* "instapy/cython_color2gray.pyx":5
 * 
 * 
...
static PyObject *__pyx_pw_7instapy_17cython_color2gray_1cython_color2gray(PyObject *__pyx_self, PyObject *__pyx_arg_img); /*proto*/
static PyArrayObject *__pyx_f_7instapy_17cython_color2gray_cython_color2gray(__Pyx_memviewslice __pyx_v_img, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_height;
  int __pyx_v_width;
  int __pyx_v_channel;
  int __pyx_v_i;
  ...
  PyObject *__pyx_v_rgb_weights = 0;
  ...
  /* "instapy/cython_color2gray.pyx":9
 *     cdef int width
 *     cdef int channel
 *     height = len(img)             # <<<<<<<<<<<<<<
 *     width = len(img[0])
...
__pyx_t_1 = __Pyx_MemoryView_Len(__pyx_t_3); 
  ...
  /* "instapy/cython_color2gray.pyx":18
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_height); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_width); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 18, __pyx_L1_error)
  ...
  __pyx_t_4 = 0;
  __pyx_t_5 = 0;
  __pyx_t_5 = PyTuple_New(1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_double); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_7) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_5numpy_ndarray), __pyx_t_5, __pyx_t_6); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  ...
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  {
    ...
    __pyx_t_8 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_7), &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_8 < 0)) {
      PyErr_Fetch(&__pyx_t_9, &__pyx_t_10, &__pyx_t_11);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out.rcbuffer->pybuffer, (PyObject*)__pyx_v_out, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "instapy/cython_color2gray.pyx":19
 *     cdef numpy.ndarray[numpy.double_t, ndim=2] out
 *     out = numpy.ndarray((height, width), dtype=numpy.double)
 *     cdef list rgb_weights = [0.21, 0.72, 0.07]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_7, 0, __pyx_float_0_21);
  __Pyx_INCREF(__pyx_float_0_72);
  __Pyx_GIVEREF(__pyx_float_0_72);
  PyList_SET_ITEM(__pyx_t_7, 1, __pyx_float_0_72);
  __Pyx_INCREF(__pyx_float_0_07);
  __Pyx_GIVEREF(__pyx_float_0_07);
  PyList_SET_ITEM(__pyx_t_7, 2, __pyx_float_0_07);
  __pyx_v_rgb_weights = ((PyObject*)__pyx_t_7);
  __pyx_t_7 = 0;

  /* "instapy/cython_color2gray.pyx":21
 *     cdef list rgb_weights = [0.21, 0.72, 0.07]
 * 
 *     for i in range(height):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
    ...
    /* "instapy/cython_color2gray.pyx":22
 * 
 *     for i in range(height):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             channel_sum = 0
 ...
 */
    ...
    for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
      ...
      /* "instapy/cython_color2gray.pyx":23
 *     for i in range(height):
 *         for j in range(width):
 *             channel_sum = 0             # <<<<<<<<<<<<<<
 *             for c in range(channel):
 ...
 */
      ...
      /* "instapy/cython_color2gray.pyx":24
 *         for j in range(width):
 *             channel_sum = 0
 *             for c in range(channel):             # <<<<<<<<<<<<<<
 *                 channel_sum += img[i][j][c] * rgb_weights[c]
 ...
 */
      ...
      for (__pyx_t_19 = 0; __pyx_t_19 < __pyx_t_18; __pyx_t_19+=1) {
        ...
        /* "instapy/cython_color2gray.pyx":25
 *             channel_sum = 0
 *             for c in range(channel):
 *                 channel_sum += img[i][j][c] * rgb_weights[c]             # <<<<<<<<<<<<<<
 *             out[i][j] = channel_sum
 * 
 */
        __pyx_t_7 = PyFloat_FromDouble(__pyx_v_channel_sum); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 25, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        ...
        __pyx_t_23 = -1;
        if (__pyx_t_20 < 0) {
          __pyx_t_20 += __pyx_v_img.shape[0];
          if (unlikely(__pyx_t_20 < 0)) __pyx_t_23 = 0;
        } else if (unlikely(__pyx_t_20 >= __pyx_v_img.shape[0])) __pyx_t_23 = 0;
        if (__pyx_t_21 < 0) {
          __pyx_t_21 += __pyx_v_img.shape[1];
          if (unlikely(__pyx_t_21 < 0)) __pyx_t_23 = 1;
        } else if (unlikely(__pyx_t_21 >= __pyx_v_img.shape[1])) __pyx_t_23 = 1;
        if (__pyx_t_22 < 0) {
          __pyx_t_22 += __pyx_v_img.shape[2];
          if (unlikely(__pyx_t_22 < 0)) __pyx_t_23 = 2;
        } else if (unlikely(__pyx_t_22 >= __pyx_v_img.shape[2])) __pyx_t_23 = 2;
        if (unlikely(__pyx_t_23 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_23);
          __PYX_ERR(0, 25, __pyx_L1_error)
        }
        __pyx_t_6 = PyFloat_FromDouble((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img.data + __pyx_t_20 * __pyx_v_img.strides[0]) ) + __pyx_t_21 * __pyx_v_img.strides[1]) ) + __pyx_t_22 * __pyx_v_img.strides[2]) )))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 25, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_5 = __Pyx_GetItemInt_List(__pyx_v_rgb_weights, __pyx_v_c, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 25, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_4 = PyNumber_Multiply(__pyx_t_6, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 25, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_t_5 = PyNumber_InPlaceAdd(__pyx_t_7, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 25, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_24 = __pyx_PyFloat_AsFloat(__pyx_t_5); if (unlikely((__pyx_t_24 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_v_channel_sum = __pyx_t_24;
      }

      /* "instapy/cython_color2gray.pyx":26
 *             for c in range(channel):
 *                 channel_sum += img[i][j][c] * rgb_weights[c]
 *             out[i][j] = channel_sum             # <<<<<<<<<<<<<<
 * 
 *     return out
 */
      __pyx_t_5 = PyFloat_FromDouble(__pyx_v_channel_sum); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_4 = __Pyx_GetItemInt(((PyObject *)__pyx_v_out), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      if (unlikely(__Pyx_SetItemInt(__pyx_t_4, __pyx_v_j, __pyx_t_5, int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    }
  }

  /* "instapy/cython_color2gray.pyx":28
 *             out[i][j] = channel_sum
 * 
 *     return out             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_v_rgb_weights);
...
/* Python wrapper */
static PyObject *__pyx_pw_7instapy_17cython_color2gray_1cython_color2gray(PyObject *__pyx_self, PyObject *__pyx_arg_img); /*proto*/
static PyObject *__pyx_pw_7instapy_17cython_color2gray_1cython_color2gray(PyObject *__pyx_self, PyObject *__pyx_arg_img) {
  ...
  __pyx_r = __pyx_pf_7instapy_17cython_color2gray_cython_color2gray(__pyx_self, __pyx_v_img);
...
static PyObject *__pyx_pf_7instapy_17cython_color2gray_cython_color2gray(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img) {
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_7instapy_17cython_color2gray_cython_color2gray(__pyx_v_img, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "instapy.cython_color2gray.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "instapy.cython_color2gray.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "instapy.cython_color2gray.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "instapy.cython_color2gray._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_cython_color2gray(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_color2gray},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcython_color2gray(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcython_color2gray(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cython_color2gray(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_color2gray(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_color2gray(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_color2gray' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cython_color2gray(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_color2gray", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
