...
class TalkingElevator(tk.Frame):
    ...
    def __init__(self, window_size="600x500"):
        # Class variables added for additional feedback
    ...
    def _add_chat(self):
        ...
        self.processor = Processor(self.respond, self.go_to, self.stop_elevator, self.get_current_floor)
    ...
    def _add_noise(self, utterance, wer=0):
    ...
    def stop_elevator(self) -> int:
        """
        New method added in order to trigger emergency stop. It is passed as a callback to the processor.
        """
    ...
    def process(self, user_message, confidence_score):
        ...
        self.processor.dispatcher(user_message, confidence_score)
