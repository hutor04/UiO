...
from oblig1b import visualize_word_vectors

# from in2110.corpora import aviskorpus_10_nn
from nak import NAK
aviskorpus_10_nn = NAK('avis-10.s.gz')
...
if __name__ == '__main__':
    ...
    print(v.nearest_neighbors('nynorsk', k=10))

    nn = v.nearest_neighbors('bokmål', k=10)
    ...
    visualize_word_vectors(v, ['bergen', 'stavanger', 'trondheim', 'oslo', 'krf', 'frp', 'sv', 'venstre', 'høyre',
                               ...
                               'nederland', 'ggyuiojlkgyuiojkhyui'])
